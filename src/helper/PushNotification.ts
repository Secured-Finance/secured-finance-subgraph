...
const subgraphID = 'Qmb8U7kEuqDXRqD9kQEaYtrpx6jB3Qy2FkNiwtJ8uVTCFQ';
...
export function sendPushNotification(
    ...
    epnsNotificationCounter.totalCount =
        epnsNotificationCounter.totalCount.plus(BigInt.fromI32(1));
    ...
    epnsPushNotification.notificationNumber =
        epnsNotificationCounter.totalCount;
